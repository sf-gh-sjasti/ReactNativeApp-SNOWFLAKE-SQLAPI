...
export default function getBearerToken() {
  ...
  //privateKey is the private key that you read from the private key file in the previous step when you generated the public key fingerprint.
  ...
  var qualified_username = "<SNOWFLAKE ACCOUNT>>.<USER NAME>>";
  var publicKeyFingerprint = "SHA256:<PUBLICK KEY FINGERPRINT FROM SNOWFLAKE>"
  var payload = {
